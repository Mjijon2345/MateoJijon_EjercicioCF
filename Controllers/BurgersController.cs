...
namespace MateoJijon_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly MateoJijon_EjercicioCFContext _context;

        public BurgersController(MateoJijon_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'MateoJijon_EjercicioCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MateoJijon_EjercicioCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
